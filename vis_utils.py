...
def imshow(inp, title=None):
    """Display a tensor as an image with optional title.
    
    Args:
        inp (Tensor): Input tensor to be displayed as an image. 
                      The tensor is expected to have shape (C, H, W) where C is the number of channels, 
